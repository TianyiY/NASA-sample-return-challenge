...
# Note: need to convert this to radians before adding to pixel_angles
rover_yaw = np.random.random(1)*360

# Generate a random rover position in world coordinates
...
# the scale associated with pixels in rover space versus world space.
# If, for example, as suggested in the previous exercise,
# you have mapped pixels in rover space such that each represents 0.1 x 0.1 m,
# and in your world map (as will be the case in the project) each pixel is 1 x 1 m,
